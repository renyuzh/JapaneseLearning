...
public class SlideMenu_yintu extends ViewGroup {
	...
	public SlideMenu_yintu(Context context) {
		this(context, null, 0);
	}

	public SlideMenu_yintu(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public SlideMenu_yintu(Context context, AttributeSet attrs, int defStyle) {
